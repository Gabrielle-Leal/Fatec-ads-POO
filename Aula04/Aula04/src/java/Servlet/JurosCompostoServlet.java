...
public class JurosCompostoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
          ...
          int Periodos = 0;
          Double Vf = 0.00, ValorPresente = 0.00;
          Double TaxaJuros = 0.00, j2 = 0.00;
          ...
          Periodos = Integer.parseInt(request.getParameter("Periodos"));
            
          j2= Periodos/100.00;
         
          Vf = ValorPresente * (Math.pow((1 +j2 ), Periodos));
          
          
        out.println("<p>Valores informados:" +ValorPresente+ ", " +Periodos+ ", " +TaxaJuros+"</p>"); 
        out.println("<p>Resultado:" +Double.parseDouble(Vf.toString())+ "</p>"); 
        }
    }
